...
<h2 style="margin-top: 24px;">Edit Data Barang</h2>
    <div class="col">
            <div class="row mt-5">
                <form class="form-input" method="POST">
                <div class="mb-3">
                    <label for="nama_barang" class="form-label">Nama barang</label>
                    <input type="text" name="nama_barang" value="<?php echo $r['nama_barang']?>" class="form-control" style="width: auto;">
                </div>
                <div class="mb-3">
                    <label for="type_barang" class="form-label">Type barang</label>
                    <input type="text" name="type_barang" value="<?php echo $r['type_barang']?>" class="form-control" style="width: auto;">
                </div>
                <div class="mb-3">
                    <label for="stok" class="form-label">stok</label>
                    <input type="text" name="stok" value="<?php echo $r['stok']?>" class="form-control" style="width: auto;">
                </div>
