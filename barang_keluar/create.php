...
if(isset($_POST['create'])){
    ...
    $jumlah=$_POST['jumlah'];
    $sql = mysqli_query($koneksi,"INSERT INTO barang_keluar VALUES('', '$id_barang', '$id_admin', '$nama_admin', '$jumlah', NOW(), 'Keluar')") or die($koneksi);
...
<h2 style="margin-top: 24px;">Buat Data Barang Keluar</h2>
