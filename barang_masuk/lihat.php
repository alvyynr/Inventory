...
<h2 style="margin-top: 24px;">Barang Masuk</h2>
        <div class="col">
            ...
            <input type="text" name="id_masuk" value="<?php echo $r['id_masuk']?>" class="form-control" style="width: auto;" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tangggal_masuk" value="<?php echo $r['tanggal_masuk']?>" class="form-control" style="width: auto;" readonly>
        </div>
        <div class="mb-3">
